                    ...
                    <div className="card border-0 shadow-sm rounded-4 mb-3">
                        ...
                        <div className="card-body text-center p-4" style={{marginTop: "-80px"}}>
                            <div className="position-relative d-inline-block">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png" className="rounded-circle border border-4 border-white shadow" width="140" height="140" alt="profile" />
                            ...
                            <h6 className="fw-bold mt-3 mb-1">Aung Kyaw</h6>
                            <p>Senior Full Stack Developer</p>
                            <span className="badge bg-success rounded-pill px-3 py-2">Active Account</span>
                            <hr />
                        </div>
                    </div>
